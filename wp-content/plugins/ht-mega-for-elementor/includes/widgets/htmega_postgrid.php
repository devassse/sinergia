...
class HTMega_Elementor_Widget_PostGrid extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            //     'post_grid_column',
            //     [
            //         'label' => esc_html__( 'Column', 'htmega-addons' ),
            //         'type' => Controls_Manager::SELECT,
            //         'options' => [
            //             '100.00'  => esc_html__('Column One','htmega-addons'),
            //             '50.00'  => esc_html__('Column Two','htmega-addons'),
            //             '33.33'   => esc_html__('Column Three','htmega-addons'),
            //             '25.00'  => esc_html__('Column Four','htmega-addons'),
            //             '20.00'   => esc_html__('Column Five','htmega-addons'),
            //             '16.66'   => esc_html__('Column Six ','htmega-addons'),
            //         ],
            //         'desktop_default' => '33.33',
            //         'tablet_default' => '50',
            //         'mobile_default' => '100',
            //         'selectors' => [
            //             '{{WRAPPER}} .htb-col-lg-4' => 'flex: 0 0 {{VALUE}}%; max-width:{{VALUE}}%;width:{{VALUE}}%',
            //         ],
            ...
            //     'show_thumbnail',
            //     [
            //         'label' => esc_html__( 'Show Thumbnail', 'htmega-addons' ),
            ...
            // );
            // $this->add_control(
            //     'show_content_under_thumbnail',
            //     [
            //         'label' => esc_html__( 'Show Content Below Thumbnail', 'htmega-addons' ),
            //         'type' => Controls_Manager::SWITCHER,
            //         'return_value' => 'yes',
            //         'default' => 'no',
            //         'condition' => [

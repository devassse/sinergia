...
<div class="widget-eli eli-blog-search contact-form" id="eli_<?php echo esc_html($this->get_id_int());?>">
    <div class="eli-container">
        <form class="eli_f" id="searchform" method="get" action="<?php bloginfo('url'); ?>/">
            <div class="eli_f_container">
                <div class="eli_f_group eli_f_group_el_s ">
                    ...
                    <input type="text" class="eli_f_field" name="s" id="s" placeholder="<?php echo esc_attr($settings['field_search_placeholder_text']); ?>" value="<?php esc_attr(the_search_query()); ?>" />
                </div>

...
class EliMap extends Elementinvader_Base {
    ...
    public function __construct($data = array(), $args = null) {
        ...
        if (true) {
            wp_enqueue_script('leaflet-maps-api', plugins_url( '/assets/libs/leaflet/leaflet.js', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ), array('jquery'));
            wp_enqueue_script('leaflet-maps-api-cluster', plugins_url( '/assets/libs/leaflet/leaflet.markercluster.js', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ), array('jquery'));
            wp_enqueue_style('leaflet-maps-api', plugins_url( '/assets/libs/leaflet/leaflet.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
            wp_enqueue_style('leaflet-maps-api-cluster-def', plugins_url( '/assets/libs/leaflet/MarkerCluster.Default.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
            wp_enqueue_style('leaflet-maps-api-cluster', plugins_url( '/assets/libs/leaflet/MarkerCluster.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
        }
    ...
    protected function render() {
        ...
        if (true) {
            ...
            wp_enqueue_script('leaflet-maps-api-cluster', plugins_url( '/assets/libs/leaflet/leaflet.markercluster.js', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ), array('jquery'));
            wp_enqueue_style('leaflet-maps-api', plugins_url( '/assets/libs/leaflet/leaflet.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
            wp_enqueue_style('leaflet-maps-api-cluster-def', plugins_url( '/assets/libs/leaflet/arkerCluster.Default.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
            wp_enqueue_style('leaflet-maps-api-cluster', plugins_url( '/assets/libs/leaflet/MarkerCluster.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ));
        } else {
